      ...
      <div className="policy-page">
        <div className="text-box">
          ...
          <p>
            ...
            asked to enter your name, email address, Website Address or other
          ...
          <p>
            ...
            places an order enters, submits, or accesses their information to
          ...
          <p>
            We may use Google AdSense Advertising on our website. Google, as a
          ...
          <p>If we happen to use Adsense, we will implement the following:</p>
          <ul>
          ...
          <ul>
            ...
            <li>
              Can change your personal information: By logging into your account
            </li>
          </ul>
          <h2>
          ...
          <p>
            ...
            place. We don't honor them because: we don't have the technical
            means.
          </p>
          <h2>
          ...
          <p>
            ...
            emails, you can email me at emma@emmahollows.co.uk
          </p>
          <p>
