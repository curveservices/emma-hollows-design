...
//             </div>
//           </NavLink>
//           <div className="portfolio-wrapper" onMouseEnter={() => setShowDropdown(true)}>
//             <NavLink
//             to="/portfolio"
//             title="Portfolio"
//             className={({ isActive }) => isActive ? 'active' : ''}
...
//               <NavLink to="/designer" className="dropdown-item">Designer</NavLink>
//               <NavLink to="/maker" className="dropdown-item">Maker</NavLink>
//               <NavLink to="/wardrobe" className="dropdown-item">Wardrobe</NavLink>
//               <NavLink to="/film" className="dropdown-item">Film</NavLink>
//               </div>
//             )}
//           </div>
//           <NavLink
